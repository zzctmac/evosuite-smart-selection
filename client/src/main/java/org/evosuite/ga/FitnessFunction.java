...
public abstract class FitnessFunction<T extends Chromosome<T>> implements Serializable {
    ...
    private FitnessFunctionWeightDecider<T> fitnessFunctionWeightDecider;

    protected double getWeight() {
        if(this.fitnessFunctionWeightDecider != null) {
            return this.fitnessFunctionWeightDecider.getWeight(this);
        }
        return 1.0;
    }
    ...
    public void setFitnessFunctionWeightDecider(FitnessFunctionWeightDecider<T> fitnessFunctionWeightDecider) {
        this.fitnessFunctionWeightDecider = fitnessFunctionWeightDecider;
    }
}
