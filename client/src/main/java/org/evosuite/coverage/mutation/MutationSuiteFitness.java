...
public abstract class MutationSuiteFitness extends TestSuiteFitnessFunction {
    ...
    public MutationSuiteFitness(Criterion criterion) {
        ...
        for (MutationTestFitness goal : factory.getCoverageGoalsForSmartCombineSuite(this)) {
    ...
    protected double getBranchScore(TestSuiteChromosome individual) {
        if(Properties.isBranchInCombination()) {
            return 0;
        }
        return branchFitness.getFitness(individual);
    }
